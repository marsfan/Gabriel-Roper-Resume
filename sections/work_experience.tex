...
{
    Software development of data concentrator avionics for commercial aircraft,
    cockpit displays for multiple applications, and hardware test harnesses for
    integration testing of avionics.
}
