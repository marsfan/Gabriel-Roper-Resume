...
\newcommand{\GPA}{3.383}
\newcommand{\Major}{Bachelor of Science (\textit{Cum Laude}) in Electrical Engineering, Robotics Track}
...
\hypersetup{
    pdftitle={\CVTitle},
    pdfauthor={\CVAuthor},
    pdfsubject={Gabriel Roper's Resume},
    pdfcreator={XeLaTeX},
    pdfproducer={},
    pdfkeywords={},
    unicode=true,
...
\begin{SubTitle}
    ...
    \\
    \href{\LinkedInPage}{\LinkedInPage}
    \BulletSymbol\space
    \href{\GithubPage}{\GithubPage}
\end{SubTitle}
